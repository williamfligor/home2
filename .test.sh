...
$RUNNER run --rm chezmoi-test zsh -ic '
    ...
    echo "[2] skills cloned / fetched..."
    for skill in avoid-ai-writing humanizer; do
        if [ -f "$HOME/.agents/skills/$skill/SKILL.md" ]; then echo "  ✓ $skill"; else echo "  ✗ $skill MISSING"; fi
    done
    if [ -f "$HOME/.agents/skills/grill-me/SKILL.md" ]; then echo "  ✓ grill-me"; else echo "  ✗ grill-me MISSING"; fi
