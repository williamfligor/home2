...
|------|-----|-------|---------|
| **Scout** | `pi` | (default) | Fast codebase scanning, context gathering |
| **Planner** | `pi` | (default) | Strategic planning, task breakdown |
| **Worker** | `pi` | (default) | Implementation, code changes |
| **Reviewer** | `pi` | (default) | Validates implementation, fixes issues |
